...
public class UsdModelExtractor( UsdStage usd )
{
	public UsdStage Stage { get; } = usd;

	public Model GetModel( string name, UsdModelSettings settings = null )
	{
		var meshPrims = Stage.Prims.Where( p => p.Type == "Mesh" ).ToArray();
